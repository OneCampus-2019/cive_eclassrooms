...
<div id="layoutSidenav_content">
    <div class="container-fluid">
        ...
        <h1 class="mt-4">Labs <i class="pull-right muted" style="font-size: 18px;"><?php echo date("F d, Y h:i:s A"); ?></i></h1>
        ...
        $sel->execute([':for_course'=>$fc, ':as_in'=>'lab']);
        $labs = $sel->fetchAll(PDO::FETCH_ASSOC);
        ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Upload Lab Answer</h5>
