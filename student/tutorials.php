...
<div id="layoutSidenav_content">
    <div class="container-fluid">
        ...
        <h1 class="mt-4">Tutorials <i class="pull-right muted" style="font-size: 18px;"><?php echo date("F d, Y h:i:s A"); ?></i></h1>
       ...
       $conn = DB::getConnection();
        ...
        $sel->execute([':file_name'=>'%.mp4', ':as_in'=>'tutorial', ':for_course'=>$fc]);
